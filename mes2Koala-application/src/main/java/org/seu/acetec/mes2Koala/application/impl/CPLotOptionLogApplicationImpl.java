...
@Named
@Transactional
public class CPLotOptionLogApplicationImpl implements CPLotOptionLogApplication {
	...
	public void createCPNode(CPLot cpLot, CPNode cpNode,String optType, String remark) {
		...
		BeanUtils.copyProperties(cpLot, cpLotOptionLog);
	...
	@Override
	public CPLotOptionLog findOne(String queryString, List<Object> params) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public CPLotOptionLog findOne(String queryString, Object... params) {
		// TODO Auto-generated method stub
		return null;
	}
