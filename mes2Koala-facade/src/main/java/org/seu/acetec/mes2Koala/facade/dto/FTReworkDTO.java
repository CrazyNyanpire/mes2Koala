...
@JsonAutoDetect
public class FTReworkDTO implements Serializable {
	...
	private List<FTReworkItemDTO> reworkItems;
	...
	public FTLotDTO getReworkLot() {
		return this.reworkLot;
	}

	public void setReworkLot(FTLotDTO reworkLot) {
	...
	public List<FTReworkItemDTO> getReworkItems() {
		return reworkItems;
	}

	public void setReworkItems(List<FTReworkItemDTO> reworkItems) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FTReworkDTO other = (FTReworkDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
