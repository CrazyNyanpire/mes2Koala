...
public class ReelDiskConvertDTO implements Serializable {
	...
	private ReelDiskConvertDTO parentSeparationDTO;
	...
	private FT_StatisticsDTO ftStatisticsDTO;
	 ...
	 * parentsIntegrationDTOs; }
	 */
	public ReelDiskConvertDTO getParentSeparationDTO() {
		return parentSeparationDTO;
	}

	public void setParentSeparationDTO(ReelDiskConvertDTO parentSeparationDTO) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReelDiskConvertDTO other = (ReelDiskConvertDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
