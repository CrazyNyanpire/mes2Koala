...
<form class="form-horizontal">
	<div class="form-group">
        ...
        <div class="col-lg-3">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="customerPPOID"/>
        </div>
        <label class="col-lg-3 control-label">Customer Lot No.:</label>
            <div class="col-lg-4">
                <input style="display:inline; width:150px;" class="form-control" type="text" id="customerLotNumberID"/>
            </div>
        </div>
    <div class="form-group">
        <label class="col-lg-2 control-label">物料类型:</label>
        <div class="col-lg-3">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="incomingStyleID"/>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="maskNameID"/>
        </div>
        <label class="col-lg-3 control-label">晶圆批号:</label>
        <div class="col-lg-4">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="waferManufacturerID"/>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="customerProductNumberID"/>
        </div>
        <label class="col-lg-3 control-label">Customer No:</label>
        <div class="col-lg-4">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="customerNumberID"/>
        </div>
    </div>
    <div class="form-group">
       ...
       <div class="input-group" style="width:160px;float:left;" >
             ...
             <input type="hidden" name="reworkType" id="reworkTypeID_" >
          </div>
       </div>
       <label class="col-lg-2 control-label">Lot No:</label>
        <div class="col-lg-4">
            <input style="display:inline; width:150px;" class="form-control" type="text" id="internalLotNumberID"/>
        </div>
    ...
    <label>wafer:</label>
    <div class="form-group">
        <label class="col-lg-1 control-label">片号:</label>
        <div class="col-lg-10">
        	<table class="table">
            <tr><td>01</td>
				<td>02</td>
        ...
        <div class="col-lg-1"><button type="button" id="InvertButton" class="btn btn-default">反选</button></div>
