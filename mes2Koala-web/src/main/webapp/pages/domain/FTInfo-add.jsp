...
<form class="form-horizontal">
    ...
    <input type="hidden" id="customerIndirectDTOPersonId" name="customerIndirectDTO.personId"/>
    <input type="hidden" id="customerIndirectDTOPersonVersion" name="customerIndirectDTO.personVersion"/>
    <input type="hidden" id="customerIndirectDTOEntryDate" name="customerIndirectDTO.entryDate"/>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <span class="required">*</span></div> -->
            <input name="packageType" style="display:inline; width:94%;" class="form-control" type="text" id="packageTypeID" dataType="Require"/>
            <span class="required">*</span>
        </div>
    </div>
