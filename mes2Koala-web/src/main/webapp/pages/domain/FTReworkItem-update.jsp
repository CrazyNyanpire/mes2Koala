...
<form class="form-horizontal">
	...
	<input type="hidden" id="versionID" name="version" /> 
	           ...
	           <div class="form-group">
		           ...
		           <div class="form-group">
                    <label class="col-lg-3 control-label">accomplishDate:</label>
	                 <div class="col-lg-9">
                    <div class="input-group date form_datetime" style="width:160px;float:left;" >
                        <input type="text" class="form-control" style="width:160px;" name="accomplishDate" id="accomplishDateID" >
                        <span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
                     </div>
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">attentionItem:</label>
	                    <div class="col-lg-9">
                           <input name="attentionItem" style="display:inline; width:94%;" class="form-control"  type="text"  id="attentionItemID" />
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">operator:</label>
	                    <div class="col-lg-9">
                           <input name="operator" style="display:inline; width:94%;" class="form-control"  type="text"  id="operatorID" />
			    </div>
	</div>
		           <div class="form-group">
                    <label class="col-lg-3 control-label">reworkFlow:</label>
	                    <div class="col-lg-9">
                           <input name="reworkFlow" style="display:inline; width:94%;" class="form-control"  type="text"  id="reworkFlowID" />
			    </div>
	</div>
	</form>
