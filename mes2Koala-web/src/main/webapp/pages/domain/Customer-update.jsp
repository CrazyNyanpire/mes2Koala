...
<form class="form-horizontal" id="form">
	...
	<div class="form-group">
		...
		<div class="col-lg-3" style="display:inline;">
			<input name="code" style="display:inline; width:94%;" class="form-control" type="hidden" id="codeID"/>
			<input name="codeDisplay" style="display:inline; width:94%;" disabled="disabled" class="form-control"
				   type="text" id="codeDisplay"/>
		</div>
	</div>
	<div class="form-group">
