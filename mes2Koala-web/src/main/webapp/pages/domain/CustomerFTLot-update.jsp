...
<form class="form-horizontal">
    ...
    <form class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input name="customerPPO" style="display:inline; width: 100px;" class="form-control" type="text"
                       id="customerPPOID"/>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input name="customerLotNumber" style="display:inline; width: 100px;" class="form-control" type="text"
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2">
                <input name="customerNumber" style="display:inline; width:100px;" class="form-control" type="text"
                       id="customerNumberID"/>
            </div>
