...
<form class="form-horizontal">
    <div class="form-group" id="serachItems">
        ...
        <label class="col-lg-2 control-label" style="margin-left:-30px;">封装批号:</label>
        <div class="col-lg-3">
    ...
    <div class="userGrantAuthority modal-body">
        ...
        <div class="middle">
            <button type="button" class="btn btn-success glyphicon glyphicon-chevron-right"
                    id="grantAuthorityToUserButton">&nbsp;合并
            </button>
            <br/><br/><br/><br/>
