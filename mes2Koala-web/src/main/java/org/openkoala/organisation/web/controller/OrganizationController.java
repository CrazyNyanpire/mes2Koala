...
public class OrganizationController extends BaseController {
    ...
    @ResponseBody
    @RequestMapping("/organizationEmployeeTree")
    public Map<String, Object> getOrganizationEmployeeTree() {
        Map<String, Object> dataMap = new HashMap<String, Object>();
        dataMap.put("orgTree", organizationFacade.getOrganizationEmpolyeeTree());
        return dataMap;
    }
