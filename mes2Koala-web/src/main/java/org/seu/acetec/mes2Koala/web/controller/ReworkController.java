...
public class ReworkController extends BaseController{
	...
	public Page pageJson(ReworkDTO reworkDTO, @RequestParam int page, @RequestParam int pagesize) {
		Page<ReworkDTO> all = reworkFacade.pageQueryRework(reworkDTO, page, pagesize);
		return all;
	}
