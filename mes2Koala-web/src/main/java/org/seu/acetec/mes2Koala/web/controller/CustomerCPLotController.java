...
public class CustomerCPLotController extends BaseController {
    ...
    public InvokeResult order(CPLotDTO cpLotDTO) {
        ...
        Long id = customerCPLotFacade.getCPinfoIdByCustomerCPLotId(cpLotDTO
    ...
    public InvokeResult placeOrders(@RequestParam String ids) {
        ...
        return customerCPLotFacade.batchOrder(idArr);
    }

    /**
     * 获取内部批号
     *
     * @param customerCPLotId CP批次Id
     * @return 内部批号
     */
    @ResponseBody
