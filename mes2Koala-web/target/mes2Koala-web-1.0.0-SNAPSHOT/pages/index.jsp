...
<head>
    ...
    <script>
        ...
        $(function(){
        	$("#meanuView").bind('click',function(){
        		$(".g-sidec").fadeIn("slow","linear");
				$(".g-sidec").css("position","relative");
				$(".g-mainc").removeClass("col-xs-12");
				$(".g-mainc").addClass("col-xs-10");
				$("#meanuView").css("display","none");
        	});
...
/*         	$("a[data-toggle='tab']").bind('click',function(){
        		if($(this).attr("href")!="#home")
       			{
	       			$(".g-sidec").css("position","absolute");
	       			$(".g-sidec").css("z-index","3");
	       			$(".g-sidec").fadeOut("slow","linear");
	       			$(".g-mainc").removeClass("col-xs-10");
	       			$(".g-mainc").addClass("col-xs-12");
	       			$("#meanuView").css("display","block");
       			}
        	}); */
...
<body>
	...
	<div class="g-head">
	    <nav class="navbar navbar-default">
	        <a class="navbar-brand" href="#">
	        	<img src="${contextPath}/images/logo.png"/ style="width:130px">
	        </a>
	...
	<div class="g-body">
	    ...
	    <span style='position:absolute;display:none;cursor: pointer;left:3px' id="meanuView" class='glyphicon glyphicon-step-forward'></span>
    ...
    <%-- 底部 --%>
	<div id="footer" class="g-foot"><span>Copyright © 2011-2016 Acetec</span></div>
</body>
</html>