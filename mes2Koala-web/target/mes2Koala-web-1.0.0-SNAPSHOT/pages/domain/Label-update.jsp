...
<body>
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-lg-6">
				<input name="labelNameDisplay" class="form-control" disabled="disabled" type="text" id="labelNameDisplayID" />
			</div>
		</div>
		<div class="form-group">
			<label class="col-lg-3 control-label">上传新标签:</label>
			<div class="col-lg-6">
				<input name="labelUpload" class="form-control" type="file" id="labelUpload" />
