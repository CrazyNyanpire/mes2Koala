...
<div class="hidden">
    ...
    <input type="text" id="ftFVIDTO_idID" name="ftPassNodeDTO.id"/>
    <input type="text" id="ftFVIDTO_versionID" name="ftPassNodeDTO.version"/>
</div>
<div class="form-group" style="margin-top: 50px">
    <label class="col-lg-2 control-label">测试结果:</label>
    <div class="col-lg-4" id="ftFVIDTO_resultID">
        <input type="radio" name="ftPassNodeDTO.result" value="1" />Pass&nbsp;&nbsp;
        <input type="radio" name="ftPassNodeDTO.result" value="0" />Fail
    </div>
</div>
</form>
<div class="form-inline" id="saveFVI">
