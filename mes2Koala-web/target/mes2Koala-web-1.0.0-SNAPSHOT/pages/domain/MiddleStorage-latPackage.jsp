    ...
    <div class="modal-dialog" style="width:1000px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                  <form class="form-horizontal">
				    ...
				    <div class="userGrantAuthority modal-body">
				            <div class="right-modal-body" style="font-size:150%;font-weight: bold;">LAT打包</div>
				            <div id="latGrid"></div>
				    </div>
				</form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="latConfirm">打包</button>
            </div>
        </div>
    </div>
</div>