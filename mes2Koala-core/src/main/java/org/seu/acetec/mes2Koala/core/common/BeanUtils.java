 ...
 * JavaBean工具类。
 *
 * @author yyang (s<a href="mailto:gdyangyu@gmail.com">gdyangyu@gmail.com</a>)
 */
public class BeanUtils {
     ...
     */
    public static void copyProperties(Object fromBean, Object toBean, String... excludeProps) {
        ...
        for (String prop : propsToCopy) {
            if (prop != null && values.containsKey(prop) && values.get(prop) != null && !"".equals(values.get(prop))) {
