...
public class Mes2DateUtils {
    ...
    public static String getAfterSomeDayYms(String date, int day) {
        Calendar c = Calendar.getInstance();
        c.setTime(Mes2DateUtils.ymdStr2Date(date));
    ...
    public static String getAttendanceDefStartDate(int year, int month) {
        ...
        return Mes2DateUtils.getAfterSomeDayYms(ymd(d.getTime()), 25);
    }
    ...
    //查询当前日期的YWW，返回字符串
    public static String getYWW() {
    	return getYYWW().substring(1);
    }
