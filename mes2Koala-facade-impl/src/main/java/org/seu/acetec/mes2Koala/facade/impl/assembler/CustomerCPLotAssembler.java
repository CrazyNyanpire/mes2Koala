...
public class CustomerCPLotAssembler {
    public static CustomerCPLotDTO toDTO(CustomerCPLot customerCPLot) {
        ...
        customerCPLotDTO.setLastModifyTimestamp(customerCPLot.getLastModifyTimestamp());
        customerCPLotDTO.setCreateEmployNo(customerCPLot.getCreateEmployNo());
        customerCPLotDTO.setLastModifyEmployNo(customerCPLot.getLastModifyEmployNo());
        customerCPLotDTO.setLogic(customerCPLot.getLogic());

        // CustomerLot
        customerCPLotDTO.setParentSeparationId(customerCPLot.getParentSeparationId());
        customerCPLotDTO.setParentIntegrationIds(customerCPLot.getParentIntegrationIds());
        customerCPLotDTO.setState(CustomerLotState.getIntValue(customerCPLot.getState()));
        ...
        customerCPLotDTO.setCustomerLotNumber(customerCPLot.getCustomerLotNumber());
        ...
        customerCPLotDTO.setInternalProductDTO(CPInfoAssembler.toDTO(customerCPLot.getCpInfo()));
    ...
    public static CustomerCPLot toEntity(CustomerCPLotDTO customerCPLotDTO) {
        ...
        customerCPLot.setLastModifyTimestamp(customerCPLotDTO.getLastModifyTimestamp());
        customerCPLot.setCreateEmployNo(customerCPLotDTO.getCreateEmployNo());
        customerCPLot.setLastModifyEmployNo(customerCPLotDTO.getLastModifyEmployNo());
        customerCPLot.setLogic(customerCPLotDTO.getLogic());

        // CustomerLot
        customerCPLot.setParentSeparationId(customerCPLotDTO.getParentSeparationId());
        customerCPLot.setParentIntegrationIds(customerCPLotDTO.getParentIntegrationIds());
        customerCPLot.setState(CustomerLotState.fromIntValue(customerCPLotDTO.getState()));
        ...
        customerCPLot.setCustomerLotNumber(customerCPLotDTO.getCustomerLotNumber());
        ...
        customerCPLot.setCpInfo(CPInfoAssembler.toEntity(customerCPLotDTO.getInternalProductDTO()));
    ...
    public static List<CustomerCPLot> toEntities(Collection<CustomerCPLotDTO> customerCPLotDTOs) {
        List<CustomerCPLot> customerCPLots = new ArrayList<CustomerCPLot>(customerCPLotDTOs.size());
    ...
    public static List<CustomerCPLotDTO> toDTOs(List<CustomerCPLot> customerCPLotList) {
        List<CustomerCPLotDTO> customerCPLotDTOs = new ArrayList<>(customerCPLotList.size());
    ...
    public static CPCustomerLotPageVo toPageVo(CustomerCPLot customerCPLot) {
        ...
        customerLotPageVo.setState(CustomerLotState.getIntValue(customerCPLot.getState()));
        customerLotPageVo.setCustomerLotNumber(customerCPLot.getCustomerLotNumber());
        ...
        customerLotPageVo.setIncomingQuantity(customerCPLot.getIncomingQuantity());
        customerLotPageVo.setIncomingStyle(customerCPLot.getIncomingStyle());
        customerLotPageVo.setCustomerProductNumber(customerCPLot.getCustomerProductNumber());
        customerLotPageVo.setIncomingDate(customerCPLot.getIncomingDate().toString());
        ...
        if (customerCPLot.getCpInfo() != null && customerCPLot.getCpInfo().getProcessTemplate() != null) {
            customerLotPageVo.setProcessName(customerCPLot.getCpInfo().getProcessTemplate().getName());
            customerLotPageVo.setProcessContent(customerCPLot.getCpInfo().getProcessTemplate().getContent());
        }
        return customerLotPageVo;
    }

    public static List<CPCustomerLotPageVo> toPageVos(Collection<CustomerCPLot> customerCPLots) {
    ...
    private static CustomerCPLot wmsJsonToEntity(JSONObject jsonObject) {
        ...
        customerCPLot.setIncomingStyle(jsonObject.optString("INCOMING_STYLE"));//到料形式以“01” （静电装散装）“02”（Tray盘箱装）的形式存储；
        customerCPLot.setIncomingDate(new Date());
        customerCPLot.setIncomingQuantity(jsonObject.optLong("QUANTITY"));
        customerCPLot.setCustomerProductNumber(jsonObject.optString("IN_PARTNUM"));
        ...
        List<JSONObject> infWafersJsonArray = (List<JSONObject>) JSONArray.toCollection(jsonObject.optJSONArray("ingWafers"), JSONObject.class);
        for (JSONObject jsonObject1 : infWafersJsonArray) {
            if (jsonObject1.optInt("IS_TRUE") == 1) {
                ...
                cpCustomerWafer.setWaferCode(jsonObject1.optString("WAFER_CODE"));
                cpCustomerWafer.setWaferIndex(jsonObject1.optString("WAFER_INDEX"));
