...
public class FTReworkFacadeImpl implements FTReworkFacade {
	...
	public InvokeResult getFTRework(Long id) {
		return InvokeResult
				.success(FTReworkAssembler.toDTO(application.get(id)));
	}
	...
	public InvokeResult creatFTRework(FTReworkDTO fTReworkDTO) {
		...
		FTProductionSchedule ftProductionSchedule = ftProductionScheduleApplication
				.findOne(
						"select o from FTProductionSchedule o where o.cpLot.id = ? ",
						fTReworkDTO.getLotId());
		ftRework.setTesterNo(ftProductionSchedule.getTestSys()
				.getTesterNumber());
		ftRework.setProduct(internalLot.getCustomerProductNumber());
	...
	public InvokeResult createReworkNo(Long id) {
		return InvokeResult.success(incrementNumberApplication
				.nextReworkNumber(ftLotapplication.get(id)));
	}
